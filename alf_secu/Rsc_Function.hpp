    ...
    class LoadingStart: RscControlsGroup {
      class controls {
        class Logo: RscPictureKeepAspect {
          text = "\ALF_Secu\ALF_Displays.jpg";
          style = 48;
          x = "0 * safezoneW";
          y = "0 * safezoneH";
          w = "1 * safezoneW";
...
class RscDisplayMain: RscStandardDisplay {
	...
	class Controls {
		...
		class Logo: RscPictureKeepAspect {
		text = "\ALF_Secu\ALF_Logo_1.paa";
		tooltip = "";
		x = "0.5000 -   5 *     (pixelW * pixelGrid * 2)";
		y = "safezoneY + (1 - 0.5 *     5) *    (pixelH * pixelGrid * 2)";
		...
		class GroupSingleplayer: RscControlsGroupNoScrollbars
		{
			...
			class Controls
			{
				...
				{		
					...
					tooltip = "";
					x = 0;
					y = "(50) * 	(pixelH * pixelGrid * 2) + 	(pixelH)";
					w = "10 * 	(pixelW * pixelGrid * 2)";
		...
		class TitleIconMultiplayer: RscButton {
			...
			colorText[]={1,1,1,1};
			colorBackground[]={0,0,0,0};
			colorBackgroundActive[]={1,1,D1,1};
